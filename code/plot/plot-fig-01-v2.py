...
def setup_subplot_ltg(ax, time, box_size, fss_data, sig_data, ltg_data, title_text, clevs1, clevs2, cmap, fontsize):
    """
    Sets up specifics of subplots for fig. 1
    """
...
setup_subplot_ltg(ax[2], ds1['time'], ds1['box_size'], ds1['fss'], sig1, ds3['lead_time_gained'], 'c) daily lead time gained', clevs1, clevs2, cmap2, fontsize)

setup_subplot_ltg(ax[3], ds2['time'], ds2['box_size'], ds2['fss'], sig2, ds4['lead_time_gained'], 'd) weekly lead time gained', clevs1, clevs2, cmap2, fontsize)
