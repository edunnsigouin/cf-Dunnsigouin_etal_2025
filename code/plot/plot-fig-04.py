...
# A) precipitation
setup_subplot(ax[0], ds1['time'], ds1['box_size'], ds1['fbss'], sig1, 'a) precipitation', clevs, cmap, fontsize)

# B) temperature 
setup_subplot(ax[1], ds2['time'], ds2['box_size'], ds2['fbss'], sig2, 'b) temperature', clevs, cmap, fontsize)
