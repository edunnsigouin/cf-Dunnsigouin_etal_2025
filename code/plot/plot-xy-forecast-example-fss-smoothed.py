...
figname_out = 'xy_example_' + variable + '_' + grid + '_' + domain + '_init_' + init_start + '_date_' + date + '_NH_' + str(NH[iNH]) + '.pdf'

# read in data & take ensemble mean
da = xr.open_dataset(path_in + filename_in).sel(time=date).mean(dim='number')[variable] 
