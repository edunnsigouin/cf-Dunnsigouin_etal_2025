...
filename1        = config.dirs['era5_forecast_' + time_flag] + '/' + variable + '/' + 'tp24_0.25x0.25_2023-08-06.nc'
filename2        = config.dirs['era5_forecast_' + time_flag] + '/' + variable + '/' + 'tp24_0.25x0.25_2023-08-07.nc'
filename3        = config.dirs['era5_forecast_' + time_flag] + '/' + variable + '/' + 'tp24_0.25x0.25_2023-08-08.nc'
filename4        = config.dirs['era5_forecast_' + time_flag] + '/' + variable + '/' + 'tp24_0.25x0.25_2023-08-09.nc'
path_out         = config.dirs['fig'] + 'paper/'
figname_out      = 'fig_XX.png'

# read in data
da1 = xr.open_dataset(filename1).isel(time=0)[variable]
da2 = xr.open_dataset(filename2).isel(time=0)[variable]
da3 = xr.open_dataset(filename3).isel(time=0)[variable]
da4 = xr.open_dataset(filename4).isel(time=0)[variable]
