...
# (A) Random noise with higher amplitude
random_field = 30.0 * np.random.rand(num_lat, num_lon)

# (B) Slightly weaker sinusoidal wave
wave_pattern = (
...
# 5. Plot
# -----------------------------
# Make the figure taller and add extra space at the bottom
...
cbar = plt.colorbar(
    ...
    fraction=0.03,   # smaller fraction => narrower bar
    pad=0.08        # more space between bar & panels
)
