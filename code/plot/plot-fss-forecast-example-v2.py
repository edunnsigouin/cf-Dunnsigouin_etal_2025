...
filename_in      = 'temp_' + time_flag + '_fss_' + variable + '_' + 'forecast_' + RF_flag + '_' + \
...
y          = fss[:,:,0].values
yerr1      = y - fss[:,:,1:].quantile(0.05,dim='number').values
yerr2      = fss[:,:,1:].quantile(0.95,dim='number').values - y
x          = fss.neighborhood
