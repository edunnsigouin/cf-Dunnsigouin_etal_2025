...
fig.text(0.5, 0.68, '0.9 quantile extremes',horizontalalignment='center',color='k',fontsize=fontsize+4)
fig.text(0.5, 0.39, '0.1 quantile extremes',horizontalalignment='center',color='k',fontsize=fontsize+4)
