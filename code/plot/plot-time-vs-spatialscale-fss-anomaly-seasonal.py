...
filename_in    = 'time_vs_ss_fss_anomaly_' + variable + '_' + domain + '_' + forecast_dates[0] + '_' + forecast_dates[-1] + '.nc'
figname_out    = 'time_vs_ss_fss_anomaly_' + variable + '_' + domain + '_' + forecast_dates[0] + '_' + forecast_dates[-1] + '.pdf'
