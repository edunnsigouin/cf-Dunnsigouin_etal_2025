...
filename_in_1     = 'fbss_tp24_time_europe_mjjas_2020-05-04_2022-09-29_0.25x0.25.nc'
filename_in_2     = 'fbss_tp24_time_europe_ndjfm_2020-01-02_2022-12-29_0.25x0.25.nc'
filename_in_3     = 'fbss_difference_time_tp24_europe_ndjfm_2020-01-02_2022-12-29_tp24_europe_mjjas_2020-05-04_2022-09-29_0.25x0.25.nc'
filename_in_4     = 'fbss_t2m24_time_europe_mjjas_2021-05-03_2021-09-30.nc'
filename_in_5     = 'fbss_t2m24_time_europe_ndjfm_2021-01-04_2021-12-30.nc'
filename_in_6     = 'fbss_difference_time_t2m24_europe_ndjfm_2021-01-04_2021-12-30_t2m24_europe_mjjas_2021-05-03_2021-09-30.nc'
...
ds4        = xr.open_dataset(path_in + filename_in_4).isel(time=slice(0,15))
ds5        = xr.open_dataset(path_in + filename_in_5).isel(time=slice(0,15))
ds6        = xr.open_dataset(path_in + filename_in_6).isel(time=slice(0,15))
...
setup_subplot(ax[0], ds1['time'], ds1['box_size'], ds1['fbss'], sig1, 'a) MJJAS precipitation', clevs, cmap, fontsize)

# B) NDJFM precipitation
setup_subplot(ax[1], ds2['time'], ds2['box_size'], ds2['fbss'], sig2, 'b) NDJFM precipitation', clevs, cmap, fontsize)

# C) NDJFM minus MJJAS precipitation
setup_subplot(ax[2], ds3['time'], ds3['box_size'], ds3['fbss'], sig3, 'c) NDJFM minus MJJAS precipitation', clevs_anom1, cmap_anom, fontsize)

# D) MJJAS temperature
setup_subplot(ax[3], ds4['time'], ds4['box_size'], ds4['fbss'], sig4, 'd) MJJAS temperature', clevs, cmap, fontsize)

# E) NDJFM temperature
setup_subplot(ax[4], ds5['time'], ds5['box_size'], ds5['fbss'], sig5, 'e) NDJFM temperature', clevs, cmap, fontsize)

# F) NDJFM minus MJJAS temperature
setup_subplot(ax[5], ds6['time'], ds6['box_size'], ds6['fbss'], sig6, 'f) NDJFM minus MJJAS temperature', clevs_anom2, cmap_anom, fontsize)
