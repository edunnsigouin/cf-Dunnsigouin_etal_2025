"""
Plots fig. S2 in Dunn-Sigouin et al. 
"""
...
def setup_subplot_xy(flag, ax, ds, clevs, cmap, fontsize):
    """ 
    Sets up specifics of subplots for fig.S2
    """
    lat   = ds.latitude
    lon   = ds.longitude
    score = ds['score']
...
filename_in_1     = 'fmsess_xy_t2m24_daily_europe_annual_boxsize_1_leadtime_5_2021-01-04_2021-12-30_0.25x0.25.nc'
filename_in_2     = 'fmsess_xy_t2m24_daily_europe_annual_boxsize_33_leadtime_5_2021-01-04_2021-12-30_0.25x0.25.nc'
filename_in_3     = 'fbss_xy_t2m24_pval0.9_daily_europe_annual_boxsize_1_leadtime_5_2021-01-04_2021-12-30_0.25x0.25.nc'
filename_in_4     = 'fbss_xy_t2m24_pval0.9_daily_europe_annual_boxsize_33_leadtime_5_2021-01-04_2021-12-30_0.25x0.25.nc'
filename_in_5     = 'fbss_xy_t2m24_pval0.1_daily_europe_annual_boxsize_1_leadtime_5_2021-01-04_2021-12-30_0.25x0.25.nc'
filename_in_6     = 'fbss_xy_t2m24_pval0.1_daily_europe_annual_boxsize_33_leadtime_5_2021-01-04_2021-12-30_0.25x0.25.nc'
