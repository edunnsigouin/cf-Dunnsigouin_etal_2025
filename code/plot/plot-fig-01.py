...
def setup_subplot_fss(flag, ax, ds, title_text, clevs, cmap, fontsize):
    ...
    contour = ax.contour(time, box_size, ds['score'], levels=clevs, linewidths=2,linestyles='-',colors = [(0.5,0.5,0.5)])
...
cb.ax.set_title('accuracy [fmsess or fbss]', fontsize=fontsize,y=1.01)
