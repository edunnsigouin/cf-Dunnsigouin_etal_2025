...
setup_subplot(ax[0], ds1['time'], ds1['box_size'], ds1['fss'], sig1, 'a) daily-mean annual precipitation', clevs, cmap, fontsize)

# B) weekly precipitation 
setup_subplot(ax[1], ds2['time'], ds2['box_size'], ds2['fss'], sig2, 'b) weekly-mean annual precipitation', clevs, cmap, fontsize)

setup_subplot(ax[2], ds3['time'], ds3['box_size'], ds3['fss'], sig3, 'c) daily-mean summer precipitation', clevs, cmap, fontsize)

setup_subplot(ax[3], ds4['time'], ds4['box_size'], ds4['fss'], sig4, 'd) daily-mean winter precipitation', clevs, cmap, fontsize)
