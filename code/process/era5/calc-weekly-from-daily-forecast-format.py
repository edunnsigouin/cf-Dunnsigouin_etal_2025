"""
Converts era5 s2s daily forecast format data into weekly.
"""
...
for date in forecast_dates:
    ...
    path_out     = config.dirs['era5_forecast_weekly'] + variable + '/'
    ...
    if variable == 'tp24':
        data.attrs['units']     = 'm'
        data.attrs['long_name'] = 'anomalies of daily accumulated precipitation'
    elif variable == 't2m24':
        data.attrs['units']     = 'K'
        data.attrs['long_name'] = 'anomalies of daily-mean 2-meter temperature'
