"""
Converts ecmwf smoothed forecast data into anomalies relative to 
corresponding smoothed hindcast climatology.
"""
    ...
    for grid in grids:
	    ...
	    # calculate anomalies from climatology
            ...
            if variable == 'tp24':
                ...
                da_anomaly.attrs['long_name'] = 'ensemble-mean anomalies of daily accumulated precipitation'
            elif variable == 't2m24':
                da_anomaly.attrs['units']     = 'K'
                da_anomaly.attrs['long_name'] = 'ensemble-mean anomalies of daily-mean 2-meter temperature'
            elif variable == 'rn24':
                da_anomaly.attrs['units']     = 'm'
                da_anomaly.attrs['long_name'] = 'ensemble-mean anomalies of daily accumulated rainfall'
            elif variable == 'mx24tpr':
                da_anomaly.attrs['units']     = 'kg m**-2 s**-1'
                da_anomaly.attrs['long_name'] = 'ensemble-mean anomalies of daily maximum timestep precipitation rate'
            elif variable == 'mx24tp6':
                da_anomaly.attrs['units']     = 'm'
                da_anomaly.attrs['long_name'] = 'ensemble-mean anomalies of daily maximum 6 hour accumulated precipitation'
            elif variable == 'mx24rn6':
                da_anomaly.attrs['units']     = 'm'
                da_anomaly.attrs['long_name'] = 'ensemble-mean anomalies of daily maximum 6 hour accumulated rainfall'
