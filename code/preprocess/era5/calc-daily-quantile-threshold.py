...
smoothed data. Estimate is taken from sample of 20 years x 
11 days for each grid point, calendar day, and spatial smoothing.

NOTE:The 11 days are taken from the +-5 days surrounding a given calendar day.
The idea is to have a sample as large as the ecmwf hindcasts which have 11 
ensemble members x 20 years.
"""
