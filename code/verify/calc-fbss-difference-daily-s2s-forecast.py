...
prefix_out              = 'fbss_difference_' + time_flag + '_' + variable1 + '_pval' + str(pval1) + '_' + domain1 + '_' + season1 + '_' + forecast_dates1[0] + '_' + forecast_dates1[-1] + \
                          '_' + variable2 + '_pval' + str(pval2) + '_' + domain2 + '_' + season2 + '_' + forecast_dates2[0] + '_' + forecast_dates2[-1] 
prefix_in_1             = 'fbss_' + variable1 + '_pval' + str(pval1) + '_' + time_flag + '_' + domain1 + '_' + season1 + '_' + forecast_dates1[0] + '_' + forecast_dates1[-1]
prefix_in_2             = 'fbss_' + variable2 + '_pval' + str(pval2) + '_' + time_flag + '_' + domain2 + '_' + season2 + '_' + forecast_dates2[0] + '_' + forecast_dates2[-1]
