...
prefix_fss              = time_flag + '_vs_ss_fss_anomaly_' + variable + '_' + domain + '_' + season + '_' + forecast_dates[0] + '_' + forecast_dates[-1] 
filename_fss_hr_out     = prefix_fss + '_0.25x0.25.nc'
filename_fss_lr_out     = prefix_fss + '_0.5x0.5.nc'
prefix_error            = time_flag + '_vs_ss_error_anomaly_' + variable + '_' + domain + '_' + season + '_' + forecast_dates[0] + '_' + forecast_dates[-1]
...
for grid in grids:
    ...
    verify.write_fss_to_file(fss, fss_bootstrap, write2file, grid, box_sizes, time_flag, filename_fss_out, path_out, comp_lev)
