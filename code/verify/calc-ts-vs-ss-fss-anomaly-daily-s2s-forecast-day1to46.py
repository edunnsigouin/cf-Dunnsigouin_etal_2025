"""
Calculates the fractional skill score as a function of lead TIME-SCALE and box size 
...
prefix               =  'ts_vs_ss_fss_anomaly_' + variable + '_' + domain + \
...
for grid in grids:
    ...
    dim            = misc.get_dim(grid,'timescale')
